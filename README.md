# SSTI-BSI
R_Code-for-Strain-Differences-in-Bloodstream-and-Skin-Infection-MRSA
...
Full_table <- read.csv("<path>/Full_table.csv")

## distance matrix 
III_Bregos_snp_dist_matrix <- as.matrix(read.delim("<path>snp_disty.txt", row.names=1))

## phylogenetic tree
III_Bregos_tree <- read.tree("<path>/parsnp.fa.treefile")
```
...
###I renumbered the clusters 1-16 in the Full_table.csv
